    ...
    <div class="home-container">
    	<div>
            <div class="my-3 d-flex justify-content-between">
                <h4 class="pl-3 home-title">Barang</h4>
            ...
            <div class="container-fluid">
	            <table class="table-button-tambah">
	                <tr>
	                    <td>
	                        <button type="button" class="btn btn-primary" onclick="window.location = '/barang/tambah'">Tambah</button>
	                    </td>
	                </tr>
	            </table>
	                ...
	                <table class="table-data stripe" id="table-data">
	                    ...
	                    <tbody>
	                        ...
	                        <tr>
	                            ...
	                            <td align="center">
	                                <button class="btn btn-primary btn-sm my-1" onclick="window.location = '/barang/edit/{{ $dt->id }}';">Edit</button>
	                            </td>
