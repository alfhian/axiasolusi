    ...
    <div class="home-container">
    	<div>
            <div class="my-3 d-flex justify-content-between">
                <h4 class="pl-3 home-title">Tambah Item</h4>
            ...
            <div class="container p-5 bg-white">
                <div class="form-group w-75">
                    <form method="post" action="/transaksi_detail/store">
                        @csrf       
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control id_barang" id="id_barang" name="id_barang" onchange="var harga = this.value.split('/')[1]; $('#harga').val(harga); " required>
                                <option value="">-- Please Choose One --</option>
                                @foreach($barang as $brg)
                                <option value="{{ $brg->id }}/{{ $brg->harga }}">{{ $brg->nama_barang }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="qty" style="margin-bottom: 0px;">Qty</label>
                            <input type="number" class="form-control" id="qty" name="qty" maxlength="3" value="1" max="100" min="1"/>
                        </div>
                        <div class="mb-3">
