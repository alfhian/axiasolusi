    ...
    <div class="home-container">
    	<div>
            <div class="my-3 d-flex justify-content-between">
                <h4 class="pl-3 home-title">Edit Barang</h4>
            ...
            <div class="container p-5 bg-white">
                <div class="form-group w-75">
                    <form method="post" action="/barang/update">
                        ...
                        <div class="mb-3">
                            <label for="nama_supplier" style="margin-bottom: 0px;">Nama Barang</label>
                            <input class="form-control" type="text" id="nama_barang" name="nama_barang" value="{{ $data->nama_barang }}" onkeyup="convertUppercase(this);" autofocus required/>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="supplier" style="margin-bottom: 0px;">Supplier</label>
                            <select class="form-control id_supplier" id="id_supplier" name="id_supplier">
                                <option value="{{ $splbrg->id }}" selected>{{ $splbrg->nama_supplier }}</option>
